...
(cl:defmethod cl:initialize-instance :after ((m <Odometry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Odometry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_drive-msg:<Odometry> is deprecated: use differential_drive-msg:Odometry instead.")))
