...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_drive-msg:<Pose> is deprecated: use differential_drive-msg:Pose instead.")))
...
(cl:defmethod theta-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:theta-val is deprecated.  Use differential_drive-msg:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose>)))
  ...
  (cl:format cl:nil "float64 timestamp~%float64 x~%float64 y~%float64 theta~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose)))
  "Returns full string definition for message of type 'Pose"
  (cl:format cl:nil "float64 timestamp~%float64 x~%float64 y~%float64 theta~%~%~%"))
