...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_drive-msg:<Path> is deprecated: use differential_drive-msg:Path instead.")))
...
(cl:ensure-generic-function 'carrot_x-val :lambda-list '(m))
(cl:defmethod carrot_x-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:carrot_x-val is deprecated.  Use differential_drive-msg:carrot_x instead.")
  (carrot_x m))

(cl:ensure-generic-function 'carrot_y-val :lambda-list '(m))
(cl:defmethod carrot_y-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:carrot_y-val is deprecated.  Use differential_drive-msg:carrot_y instead.")
  (carrot_y m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Path>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'carrot_x))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-double-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream)))
   (cl:slot-value msg 'carrot_x))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'carrot_y))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Path>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'carrot_x) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'carrot_x)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'carrot_y) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'carrot_y)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Path>)))
  ...
  (cl:format cl:nil "float64[] x~%float64[] y~%float64[] theta~%float64[] carrot_x~%float64[] carrot_y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Path)))
  "Returns full string definition for message of type 'Path"
  (cl:format cl:nil "float64[] x~%float64[] y~%float64[] theta~%float64[] carrot_x~%float64[] carrot_y~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Path>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'carrot_x) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'carrot_y) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Path>))
  ...
  (cl:list 'Path
    ...
    (cl:cons ':carrot_x (carrot_x msg))
    (cl:cons ':carrot_y (carrot_y msg))
))
