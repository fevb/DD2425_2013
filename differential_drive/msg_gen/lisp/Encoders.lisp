...
(cl:defmethod cl:initialize-instance :after ((m <Encoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_drive-msg:<Encoders> is deprecated: use differential_drive-msg:Encoders instead.")))

(cl:ensure-generic-function 'delta_encoder1-val :lambda-list '(m))
(cl:defmethod delta_encoder1-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:delta_encoder1-val is deprecated.  Use differential_drive-msg:delta_encoder1 instead.")
  (delta_encoder1 m))

(cl:ensure-generic-function 'delta_encoder2-val :lambda-list '(m))
(cl:defmethod delta_encoder2-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:delta_encoder2-val is deprecated.  Use differential_drive-msg:delta_encoder2 instead.")
  (delta_encoder2 m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Encoders>)))
  ...
  (cl:format cl:nil "# Change of encoders during timestamp millisseconds~%~%int32 delta_encoder1~%int32 delta_encoder2~%~%~%int32 timestamp~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Encoders)))
  "Returns full string definition for message of type 'Encoders"
  (cl:format cl:nil "# Change of encoders during timestamp millisseconds~%~%int32 delta_encoder1~%int32 delta_encoder2~%~%~%int32 timestamp~%~%~%~%"))
